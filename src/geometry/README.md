...
Choose one adapter per operation: Paper for geometry primitives; flubber for qualified closed single contours; polymorph-js only after corpus qualification; opentype.js for font outlines after shaping/permission checks. Reject ambiguous topology changes. See [repair specification](../../docs/ai-capabilities-and-repair.md).

...
- **Line Art to Motion**: Animating a still reference drawing? Follow `skills/line-art-motion/SKILL.md` (`/line-art-motion`) and `docs/pipelines/line-art-to-motion-pipeline.md`.

...
This is the **why and how-to-review** companion to the normative [v2 recreation contract](motion-video-recreation-pipeline.md). Start with that contract. The [Astra plan](../../plans/cases/astra-for-law-recreation.md) and [temporal audit](../../plans/cases/astra-law-temporal-audit.md) contain case-specific observations; source timestamps and design choices in them are not universal presets.

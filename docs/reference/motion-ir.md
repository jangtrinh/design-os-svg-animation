...
Lưu ý integration: [authoring spec v1.0](motion-ir-specification.md) xuất hiện từ phiên đồng thời. Schema 0.1.0 ở đây là đề xuất lớp normalized riêng, chưa có resolver; không tự thay authority của authoring spec. Xem [mapping hai lớp](../architecture/architecture-supplement.md).
